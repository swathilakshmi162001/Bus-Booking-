                                    ...
                                    <div className="col-md-6">
                                        <form className="form" onSubmit={e => onSubmit(e)}>
                                            <div className="form-group2">
                                                ...
                                                <input type="text" placeholder="Enter your Name" name="name" value={name} className="form-control sgnUp" onChange={e => onChange(e)} />
                                            </div>
                                            <div className="form-group2">
                                                <label htmlFor="email">Email-ID:</label>
                                                <input required name="email" placeholder="Enter your Email Id" value={email} type="email" className="form-control sgnUp" onChange={e => onChange(e)} />
                                            </div>
                                            <div className="form-group2">
                                                <label htmlFor="mob-number">Mobile-No.:</label>
                                                <input required id="mob-number" placeholder="type your Mobile No" type="text" name="contact" value={contact} className="form-control sgnUp" onChange={e => onChange(e)} />
                                            </div>
                                            <div className="form-group2">
                                            ...
                                            <div className="form-group2">
                                                ...
                                                <input required id="password" name="password" value={password} placeholder="Enter your Password" type="password" className="form-control sgnUp" onChange={e => onChange(e)} />
                                            </div>
                                            <div className="form-group2">
                                                <label htmlFor="password">Re-Password :</label>
                                                <input required id="password2" name="password2" value={password2} placeholder="Enter your Conform Password" type="password" className="form-control sgnUp" onChange={e => onChange(e)} />
                                            </div>
                                            <div className="form-group2">
